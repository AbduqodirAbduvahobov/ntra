...
CREATE TABLE `branch` (
                          ...
                          `created_at` timestamp NULL DEFAULT NULL,
                          PRIMARY KEY (`id`),
                          CONSTRAINT `branch_ibfk_1` FOREIGN KEY (`id`) REFERENCES `ads` (`branch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `status` (
                          ...
                          `name` varchar(255) DEFAULT NULL,
                          PRIMARY KEY (`id`),
                          CONSTRAINT `status_ibfk_1` FOREIGN KEY (`id`) REFERENCES `ads` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
                         ...
                         `created_at` timestamp NULL DEFAULT NULL,
                         PRIMARY KEY (`id`),
                         CONSTRAINT `users_ibfk_1` FOREIGN KEY (`id`) REFERENCES `ads` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-08 18:53:10